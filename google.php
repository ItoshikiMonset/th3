...
<script type="text/javascript">
    var glogin;
    function GloginAuth() {
        glogin = window.open("<?php echo $apiurl . '&return=' . $myurl . 'google.php'; ?>&login", "GLogin", "height=500,width=370,top=70,left=200");
        glogin.focus();
    }
function GlogoutAuth(){
        gid = document.getElementById( 'g_fid' ).value ;
        glogout = window.open("<?php echo $apiurl . '&return=' . $myurl . 'google.php'; ?>&logout=susutun&gid=" + gid, "GLogout", "height=500,width=370,top=70,left=200");
        glogout.focus();
}
...
<input type="button" value="Change Account" onclick="GloginAuth()"/>
<input type="button" value="Logout" onclick="GlogoutAuth()"/>
                                        </td>
                                    </tr>
				</table>
			</div>
...
echo '
<form name="logout_form" id="logout_form" action="google.php" method="POST">
